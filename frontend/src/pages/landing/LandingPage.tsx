  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950 text-slate-900 dark:text-slate-100 transition-colors duration-300 font-sans selection:bg-sky-500 selection:text-white">
        ...
        <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              ...
              className="flex items-center gap-2 text-sm font-semibold text-slate-700 dark:text-slate-200 hover:text-sky-600 dark:hover:text-sky-400 px-4 py-2.5 rounded-md transition-all cursor-pointer bg-slate-100 dark:bg-slate-800"
            >
              <LogIn size={16} />
              Sign in
            </button>
      ...
      <main className="relative z-10">
        ...
        <section className="pt-16 pb-24 px-6 max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-12 gap-12 items-center">
            ...
            <div className="lg:col-span-7 space-y-6 text-left">
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-md bg-sky-100 dark:bg-sky-500/10 text-sky-700 dark:text-sky-400 text-xs font-bold tracking-wide uppercase shadow-sm">
              ...
              <div className="flex flex-wrap items-center gap-4 pt-2">
                ...
                <button
                  onClick={() => navigate("/login")}
                  className="flex items-center gap-2 text-base font-semibold text-slate-700 dark:text-slate-200 bg-white dark:bg-slate-800 px-6 py-4 rounded-md shadow-sm transition-all cursor-pointer"
                >
              ...
              {/* Trust Badges */}
              <div className="pt-6 flex flex-wrap items-center gap-6 text-xs font-semibold text-slate-500 dark:text-slate-400">
            ...
            <div className="lg:col-span-5 relative">
              <div className="relative bg-white dark:bg-slate-900 rounded-md p-6 shadow-sm space-y-5">
                {/* Header of Mock Card */}
                <div className="flex justify-between items-center pb-4">
                  <div className="flex items-center gap-3">
                    <div className="w-10 h-10 rounded-md bg-amber-500/10 text-amber-500 flex items-center justify-center font-bold">
                      <Zap size={20} />
                    </div>
                    <div>
                  ...
                  <span className="px-3 py-1 rounded-sm text-xs font-bold bg-sky-500/10 text-sky-600 dark:text-sky-400">
                    IN PROGRESS
                  </span>
                </div>
                ...
                <div className="bg-slate-900 text-white rounded-md p-4 flex items-center justify-between shadow-sm">
                  ...
                  <span className="text-xs font-semibold px-2.5 py-1 rounded-sm bg-emerald-500/20 text-emerald-300">
                    On Schedule
                  </span>
                </div>
                ...
                <div className="space-y-2 pt-2">
                  <div className="flex items-center gap-3 text-xs">
                    <div className="w-5 h-5 rounded-md bg-emerald-500 text-white flex items-center justify-center text-[10px] font-bold">✓</div>
                  ...
                  <div className="flex items-center gap-3 text-xs">
                    <div className="w-5 h-5 rounded-md bg-sky-500 text-white flex items-center justify-center text-[10px] font-bold">✓</div>
                  ...
                  <div className="flex items-center gap-3 text-xs">
                    <div className="w-5 h-5 rounded-md bg-amber-500/20 text-amber-500 flex items-center justify-center text-[10px] font-bold">●</div>
        ...
        {/* METRICS & IMPACT BAR */}
        <section id="stats" className="scroll-mt-24 py-12 bg-white dark:bg-slate-900 shadow-sm">
        ...
        <section id="features" className="scroll-mt-24 py-24 px-6 max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {/* Feature 1 */}
            <div className="bg-white dark:bg-slate-900 rounded-md p-8 shadow-sm group">
              <div className="w-14 h-14 rounded-md bg-sky-500/10 text-sky-600 dark:text-sky-400 flex items-center justify-center mb-6">
                <Clock size={28} />
              </div>
            ...
            {/* Feature 2 */}
            <div className="bg-white dark:bg-slate-900 rounded-md p-8 shadow-sm group">
              <div className="w-14 h-14 rounded-md bg-blue-500/10 text-blue-600 dark:text-blue-400 flex items-center justify-center mb-6">
            ...
            {/* Feature 3 */}
            <div className="bg-white dark:bg-slate-900 rounded-md p-8 shadow-sm group">
              <div className="w-14 h-14 rounded-md bg-purple-500/10 text-purple-600 dark:text-purple-400 flex items-center justify-center mb-6">
                <Building2 size={28} />
              </div>
            ...
            {/* Feature 4 */}
            <div className="bg-white dark:bg-slate-900 rounded-md p-8 shadow-sm group">
              <div className="w-14 h-14 rounded-md bg-emerald-500/10 text-emerald-600 dark:text-emerald-400 flex items-center justify-center mb-6">
                <ShieldCheck size={28} />
              </div>
            ...
            {/* Feature 5 */}
            <div className="bg-white dark:bg-slate-900 rounded-md p-8 shadow-sm group">
              <div className="w-14 h-14 rounded-md bg-amber-500/10 text-amber-600 dark:text-amber-400 flex items-center justify-center mb-6">
                <BarChart3 size={28} />
              </div>
            ...
            {/* Feature 6 */}
            <div className="bg-white dark:bg-slate-900 rounded-md p-8 shadow-sm group">
              <div className="w-14 h-14 rounded-md bg-rose-500/10 text-rose-600 dark:text-rose-400 flex items-center justify-center mb-6">
                <Users size={28} />
              </div>
        ...
        <section id="how-it-works" className="scroll-mt-24 py-20 px-6 bg-slate-100 dark:bg-slate-900/50">
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid md:grid-cols-4 gap-6">
              <div className="bg-white dark:bg-slate-900 p-6 rounded-md shadow-sm relative">
                <span className="w-9 h-9 rounded-md bg-sky-500 text-white font-bold flex items-center justify-center text-sm mb-4">1</span>
              ...
              <div className="bg-white dark:bg-slate-900 p-6 rounded-md shadow-sm relative">
                <span className="w-9 h-9 rounded-md bg-blue-500 text-white font-bold flex items-center justify-center text-sm mb-4">2</span>
              ...
              <div className="bg-white dark:bg-slate-900 p-6 rounded-md shadow-sm relative">
                <span className="w-9 h-9 rounded-md bg-purple-500 text-white font-bold flex items-center justify-center text-sm mb-4">3</span>
              ...
              <div className="bg-white dark:bg-slate-900 p-6 rounded-md shadow-sm relative">
                <span className="w-9 h-9 rounded-md bg-emerald-500 text-white font-bold flex items-center justify-center text-sm mb-4">4</span>
        ...
        <section id="roles" className="scroll-mt-24 py-24 px-6 max-w-7xl mx-auto">
          ...
          <div className="flex justify-center gap-3 mb-10">
            <button
              ...
              className={`px-5 py-3 rounded-md font-bold text-sm transition-all cursor-pointer ${
                activeTab === "residents"
          ...
          <div className="bg-white dark:bg-slate-900 rounded-md p-8 shadow-sm">
            {activeTab === "residents" && (
              <div className="grid md:grid-cols-2 gap-8 items-center">
                <div className="space-y-4">
                  <span className="px-3 py-1 rounded-sm text-xs font-bold bg-sky-100 text-sky-700 dark:bg-sky-500/10 dark:text-sky-400">
                    For Residents
                  </span>
                ...
                <div className="bg-slate-100 dark:bg-slate-800 p-6 rounded-md">
                  ...
                  <div className="space-y-3">
                    <div className="bg-white dark:bg-slate-900 p-3 rounded-md flex justify-between items-center text-xs">
                      <div>
                      ...
                      <span className="px-2.5 py-1 rounded-sm bg-sky-500/10 text-sky-600 dark:text-sky-400 font-bold">In Progress</span>
                    </div>
                    <div className="bg-white dark:bg-slate-900 p-3 rounded-md flex justify-between items-center text-xs">
                      <div>
                      ...
                      <span className="px-2.5 py-1 rounded-sm bg-emerald-500/10 text-emerald-600 dark:text-emerald-400 font-bold">Resolved</span>
                    </div>
                  </div>
                </div>
              </div>
            ...
            {activeTab === "admins" && (
              <div className="grid md:grid-cols-2 gap-8 items-center">
                <div className="space-y-4">
                  <span className="px-3 py-1 rounded-sm text-xs font-bold bg-blue-100 text-blue-700 dark:bg-blue-500/10 dark:text-blue-400">
                    For Society Admins
                  </span>
            ...
            {activeTab === "superadmin" && (
              <div className="grid md:grid-cols-2 gap-8 items-center">
                <div className="space-y-4">
                  <span className="px-3 py-1 rounded-sm text-xs font-bold bg-purple-100 text-purple-700 dark:bg-purple-500/10 dark:text-purple-400">
                ...
                <div className="bg-slate-100 dark:bg-slate-800 p-6 rounded-md">
                  ...
                  <div className="bg-white dark:bg-slate-900 p-4 rounded-md space-y-2 text-xs">
        ...
        <section className="py-20 px-6 max-w-7xl mx-auto">
          <div className="relative rounded-md bg-slate-900 text-white p-12 overflow-hidden shadow-sm">
            <div className="relative z-10 max-w-3xl space-y-6 text-left">
              ...
              <div className="flex flex-wrap gap-4 pt-4">
                ...
                <button
                  onClick={() => navigate("/login")}
                  className="flex items-center gap-2 text-base font-semibold text-white bg-slate-800 hover:bg-slate-700 px-7 py-4 rounded-md shadow-sm transition-all cursor-pointer"
                >
                  <LogIn size={18} />
                  <span>Sign In</span>
                </button>
      ...
      <footer className="bg-white dark:bg-slate-900 py-12 px-6 shadow-sm">
        <div className="max-w-7xl mx-auto flex flex-col sm:flex-row justify-between items-center gap-6 text-xs text-slate-500 dark:text-slate-400">
          <div className="flex items-center gap-3">
            <div className="w-7 h-7 rounded-md bg-sky-600 text-white font-bold flex items-center justify-center text-sm shadow-sm">
              C
            </div>
          ...
          <div className="flex gap-6">
            <button onClick={() => navigate("/login")} className="hover:text-sky-500 transition-colors cursor-pointer">
              Login
            </button>
            <button onClick={() => navigate("/signup")} className="hover:text-sky-500 transition-colors cursor-pointer">
              Signup
            </button>
            <a
              href="#features"
